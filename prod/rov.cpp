...
static void i2c_slave_handler(i2c_inst_t *i2c, i2c_slave_event_t event) {
    ...
    switch (event){
        ...
        thrust = thrust_gain / 100.0f;  // Convert back to 0.0-1.0 range
        ...
        switch(signal) {
            ...
            case 17: gpio_put(LED_PIN, 1); break; // Turn on LED
        ...
        i2c_write_byte_raw(i2c, data[0]);
        i2c_write_byte_raw(i2c, data[1]);
        break;
